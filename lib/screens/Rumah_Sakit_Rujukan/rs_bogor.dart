...
class RSBogor extends StatefulWidget {
  @override
  _RSBogorState createState() => _RSBogorState();
}

class _RSBogorState extends State<RSBogor> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('Rs Rujukan Bogor'),
        ),
        backgroundColor: Colors.white,
        body: StreamBuilder<QuerySnapshot>(
          stream: dataRS.where("kota", isEqualTo: "bogor").snapshots(),
          builder: (_, snapshot) {
            if (snapshot.hasData) {
