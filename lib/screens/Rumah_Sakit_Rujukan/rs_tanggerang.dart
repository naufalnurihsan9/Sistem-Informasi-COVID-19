...
class RSTanggerang extends StatefulWidget {
  @override
  _RSTanggerangState createState() => _RSTanggerangState();
}

class _RSTanggerangState extends State<RSTanggerang> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('Rs Rujukan Tanggerang'),
        ),
        backgroundColor: Colors.white,
        body: StreamBuilder<QuerySnapshot>(
          stream: dataRS.where('kota', isEqualTo: "tanggerang").snapshots(),
          builder: (_, snapshot) {
            if (snapshot.hasData) {
